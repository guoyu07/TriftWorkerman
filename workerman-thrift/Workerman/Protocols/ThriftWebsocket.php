 ...
 * WebSocket protocol.
 */
class ThriftWebsocket implements \Workerman\Protocols\ProtocolInterface
{
    /**
    ...
    {
    	$buffer = $buffer['class_name'].'::'.$buffer['body'];
        $len = strlen($buffer);
    ...
    public static function decode($buffer, ConnectionInterface $connection)
    {
        ...
        if ($connection->websocketCurrentFrameLength) {
            ...
            $data = explode("::",$decoded,2);
            $data['class_name'] = $data[0];
            $data['body'] = $data[1];      
            unset($data[0]);
            unset($data[1]);
            return $data;
